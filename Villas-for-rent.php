...
$result = mysqli_query($conn,"select * from Villas_for_rent ORDER BY OID DESC");
...
<a  href="Villas-for-rent-details.php?id=<?php echo @$row['OID'] ; ?>"   type="button" class=" btn btn-primary btn-lg btn-block mt-5"  style="opacity: 0.6;"  >مشاهدة التفاصيل</a> 
<?php
if(@$_SESSION['Type'] == "" ){ 
}else if($_SESSION['Type'] == 3){
?>
<a  href="Villas-for-rent-edit.delete.php?id=<?php echo @$row['OID'] ; ?>"   type="button" class=" btn btn-danger  btn-block  "  style="opacity: 0.6;height:30px;"><h6>تعديل</h6></a> 
<?php
