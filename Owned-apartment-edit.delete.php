...
@$id = $_GET['id'];
$searsh = " select * from Owned_apartment where OID='$id' ";
...
<div class="col-md-6">
<input autocomplete="off" id="halls" type="halls" class="form-control" name="halls" value="<?php echo @$row['halls'] ; ?>"  required   style="background-color: rgba(232,232,232,0.6);">
</div>
</div>
<div class="form-group row">
...
<option selected value="<?php echo @$row['elevator'] ; ?>" ><?php echo @$row['elevator'] ; ?></option>
<option value="يوجد">يوجد</option>
<option value="لا يوجد"> لا يوجد </option>
</select>
</div>
...
$update = "update Owned_apartment set city = '$city', location = '$location', space = '$space', price = '$price', halls = '$halls', rooms = '$rooms', paths = '$paths', balconies = '$balconies', garden = '$garden', garage = '$garage', elevator = '$elevator', guard = '$guard', detials = '$detials', image_a = '$pica', image_b = '$picb', image_c = '$picc', image_d = '$picd', image_e = '$pice', image_f = '$picf'  where OID='$id' ";

$iquery = mysqli_query($conn,$update);

unlink('pic\apartment\owned_img\\'.@$row['image_a']);
unlink('pic\apartment\owned_img\\'.@$row['image_b']);
unlink('pic\apartment\owned_img\\'.@$row['image_c']);
unlink('pic\apartment\owned_img\\'.@$row['image_d']);
unlink('pic\apartment\owned_img\\'.@$row['image_e']);
unlink('pic\apartment\owned_img\\'.@$row['image_f']);
...
$delete = "delete from Owned_apartment where OID='$id' ";
