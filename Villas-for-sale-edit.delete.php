...
$update = "update Owned_villas set city = '$city', location = '$location', space = '$space', price = '$price', rooms = '$rooms', paths = '$paths', balconies = '$balconies', garden = '$garden', garage = '$garage', guard = '$guard', detials = '$detials', image_a = '$pica', image_b = '$picb', image_c = '$picc', image_d = '$picd', image_e = '$pice', image_f = '$picf'  where OID='$id' ";

$iquery = mysqli_query($conn,$update);

unlink('pic\Villas\sale_img\\'.@$row['image_a']);
unlink('pic\Villas\sale_img\\'.@$row['image_b']);
unlink('pic\Villas\sale_img\\'.@$row['image_c']);
unlink('pic\Villas\sale_img\\'.@$row['image_d']);
unlink('pic\Villas\sale_img\\'.@$row['image_e']);
unlink('pic\Villas\sale_img\\'.@$row['image_f']);
...
$delete = "delete from Owned_villas where OID='$id' ";
