...
$result = mysqli_query($conn,"select * from Pro ORDER BY proID DESC");
if(@$_SESSION['Type'] == "" ){ 
}else if($_SESSION['Type'] > 1){
?>
<a href="new-pro-add.php"  type="button" class=" btn btn-success btn-lg btn-block mb-5 "  style="opacity: 0.6;" >اضف مشروع جديد </a> 
<?php
}else if($_SESSION['Type'] == 1){
}else{
...
<a  href="new-pro-details.php?id=<?php echo @$row['proID'] ; ?>"   type="button" class=" btn btn-primary btn-lg btn-block mt-5"  style="opacity: 0.6;"  >مشاهدة التفاصيل</a> 
<?php
if(@$_SESSION['Type'] == "" ){ 
}else if($_SESSION['Type'] == 3){
?>
<a  href="new-pro-edit.delete.php?id=<?php echo @$row['proID'] ; ?>"   type="button" class=" btn btn-danger  btn-block  "  style="opacity: 0.6;height:30px;"><h6>تعديل</h6></a> 
<?php
