...
@$id = $_GET['id'];
$searsh = " select * from old_rent_apartment where OID='$id' ";
...
$update = "update old_rent_apartment set city = '$city', location = '$location', space = '$space', price = '$price', halls = '$halls', rooms = '$rooms', paths = '$paths', balconies = '$balconies', garden = '$garden', garage = '$garage', elevator = '$elevator', guard = '$guard', detials = '$detials', image_a = '$pica', image_b = '$picb', image_c = '$picc', image_d = '$picd', image_e = '$pice', image_f = '$picf'  where OID='$id' ";

$iquery = mysqli_query($conn,$update);

unlink('pic\apartment\old_img\\'.@$row['image_a']);
unlink('pic\apartment\old_img\\'.@$row['image_b']);
unlink('pic\apartment\old_img\\'.@$row['image_c']);
unlink('pic\apartment\old_img\\'.@$row['image_d']);
unlink('pic\apartment\old_img\\'.@$row['image_e']);
unlink('pic\apartment\old_img\\'.@$row['image_f']);
...
$delete = "delete from old_rent_apartment where OID='$id' ";
