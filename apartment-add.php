...
$selected = $_POST['type'];
	...
	header( "refresh:1;url=apartment-add.php" );
	?>
...
move_uploaded_file($tmp_namea, "pic\apartment\owned_img\\" . $pica);
...
move_uploaded_file($tmp_nameb, "pic\apartment\owned_img\\" . $picb);
...
move_uploaded_file($tmp_namec, "pic\apartment\owned_img\\" . $picc);
...
move_uploaded_file($tmp_named, "pic\apartment\owned_img\\" . $picd);
...
move_uploaded_file($tmp_namee, "pic\apartment\owned_img\\" . $pice);
...
move_uploaded_file($tmp_namef, "pic\apartment\owned_img\\" . $picf);

$insert = "INSERT INTO Owned_apartment (city, location, type, space, price, halls, rooms, paths, balconies, garden, garage, elevator, guard, detials, image_a, image_b, image_c, image_d, image_e, image_f, userID, userName, Email, Phone) 
VALUES('$city','$location','$type','$space','$price','$halls','$rooms','$paths','$balconies','$garden','$garage','$elevator','$guard','$detials','$pica','$picb','$picc','$picd','$pice','$picf','$userID','$userName','$Email','$Phone')";

$iquery = mysqli_query($conn,$insert);

if ($iquery)
{
    header( "refresh:1;url=Owned-apartment.php" );
    ?>
...
move_uploaded_file($tmp_namea, "pic\apartment\\new\\" . $pica);
...
move_uploaded_file($tmp_nameb, "pic\apartment\\new\\" . $picb);
...
move_uploaded_file($tmp_namec, "pic\apartment\\new\\" . $picc);
...
move_uploaded_file($tmp_named, "pic\apartment\\new\\" . $picd);
...
move_uploaded_file($tmp_namee, "pic\apartment\\new\\" . $pice);
...
move_uploaded_file($tmp_namef, "pic\apartment\\new\\" . $picf);

$insertt = "INSERT INTO new_rent_apartment (city, location, type, space, price, halls, rooms, paths, balconies, garden, garage, elevator, guard, detials, image_a, image_b, image_c, image_d, image_e, image_f, userID, userName, Email, Phone) 
VALUES('$city','$location','$type','$space','$price','$halls','$rooms','$paths','$balconies','$garden','$garage','$elevator','$guard','$detials','$pica','$picb','$picc','$picd','$pice','$picf','$userID','$userName','$Email','$Phone')";

$iqueryy = mysqli_query($conn,$insertt);
if ($iqueryy)
{
    header( "refresh:1;url=New-rent-apartment.php" );
    ?>
    <div id="textt" class="container-sm " style="width:400px;height:250px;border-radius: 40px;background-color:rgba(31, 140, 54, 0.85);box-shadow: -4px 0px 9px 7px rgba(31, 140, 54, 0.85);text-align: center;color:#fff;position:fixed;top: 150;right: 0;bottom: 200;left: 0;z-index:100;">
    <button type="button" class="close m-4 " id="text" onmouseover="document.getElementById('textt').style.display = 'none'" aria-label="Close">
    <i class="fas fa-times" style="color:#fff;"></i>
...
move_uploaded_file($tmp_namea, "pic\apartment\old_img\\" . $pica);
...
move_uploaded_file($tmp_nameb, "pic\apartment\old_img\\" . $picb);
...
move_uploaded_file($tmp_namec, "pic\apartment\old_img\\" . $picc);
...
move_uploaded_file($tmp_named, "pic\apartment\old_img\\" . $picd);
...
move_uploaded_file($tmp_namee, "pic\apartment\old_img\\" . $pice);
...
move_uploaded_file($tmp_namef, "pic\apartment\old_img\\" . $picf);

$insert = "INSERT INTO old_rent_apartment (city, location, type, space, price, halls, rooms, paths, balconies, garden, garage, elevator, guard, detials, image_a, image_b, image_c, image_d, image_e, image_f, userID, userName, Email, Phone) 
VALUES('$city','$location','$type','$space','$price','$halls','$rooms','$paths','$balconies','$garden','$garage','$elevator','$guard','$detials','$pica','$picb','$picc','$picd','$pice','$picf','$userID','$userName','$Email','$Phone')";
...
if ($iquery)
{
    header( "refresh:1;url=old-rent-apartment.php" );
    ?>
    <div id="textt" class="container-sm " style="width:400px;height:250px;border-radius: 40px;background-color:rgba(31, 140, 54, 0.85);box-shadow: -4px 0px 9px 7px rgba(31, 140, 54, 0.85);text-align: center;color:#fff;position:fixed;top: 150;right: 0;bottom: 200;left: 0;z-index:100;">
    <button type="button" class="close m-4 " id="text" onmouseover="document.getElementById('textt').style.display = 'none'" aria-label="Close">
    <i class="fas fa-times" style="color:#fff;"></i>
...
<form  method="POST" action="apartment-add.php" enctype="multipart/form-data">
...
<div class="form-group row">
<label for="halls" class="col-md-4 col-form-label text-md-right">عدد الصالات </label>
<div class="col-md-6">
<input autocomplete="off" id="halls" type="halls" class="form-control" name="halls" required   style="background-color: rgba(232,232,232,0.6);">
</div>
</div>
<div class="form-group row">
...
<div class="form-group row">
<label for="elevator" class="col-md-4 col-form-label text-md-right">اسانسير</label>
<div class="col-md-6">
<select class="custom-select"  name="elevator"  id="inputGroupSelect04"   required   aria-label="Example select with button addon"style="background-color: rgba(232,232,232,0.6);">
<option selected></option>
<option value="يوجد">يوجد</option>
<option value="لا يوجد"> لا يوجد </option>
</select>
